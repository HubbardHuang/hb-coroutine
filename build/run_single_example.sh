...
yellow_echo "[1/3] 将 source 目录中的文件编译生成动态链接库 libhbco.so"
${script_path}/make_shared_lib.sh "$2"
yellow_echo "[2/3] 编译 test/example_$1.cpp 并链接 libhbco.so 生成 example_$1.exe"
${script_path}/make_example_exe.sh $1 "$2"
yellow_echo "[3/3] 运行 example_$1.exe"
echo -e "\n"
# sleep 2s
